...
import {sweet} from "../../public/foodcategories" ;
        ...
        <div className="w-3/4 grid grid-cols-3 gap-2 mx-auto mt-10">
        {
                sweet?.map((mithai)=>{
                    ...
                    return(
                        ...
                        <Image src={mithai.img} alt={mithai.name} className="w-32 h-32 mx-auto mt-5" />
                        <div className="mt-4 text-center">{mithai.name}</div>
                        <div className="mt-2 text-center">Rs.{mithai.price} for one</div>
