        ...
        <div className="w-3/4 grid grid-cols-3 gap-2 mx-auto mt-10">
        {
                juice?.map((drinks)=>{
                    ...
                    return(
                        ...
                        <Image src={drinks.img} alt={drinks.name} className="w-32 h-32 mx-auto mt-5" />
                        <div className="mt-4 text-center">{drinks.name}</div>
                        <div className="mt-2 text-center">Rs.{drinks.price} for one</div>
